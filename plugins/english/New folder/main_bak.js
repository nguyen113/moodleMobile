...
define(templates, function (listeningVideo, manager, gallery, add_video, score, langStringEN) {	
	var plugin = {
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        settings: {
            ...
            subMenus: [
				...
				{name: "addVideo", menuURL: "#english/add_video", icon: "plugins/english/icon.png"}
            ],
            lang: {
                component: "english",
        ...
        routes: [
			...
			["english/add_video", "english_add_video", "showAddEditVideo"]
        ],
		...
		showAddEditVideo: function() {
            MM.Router.navigate("");
            MM.log('Navigate to add page', 'english');
			var tpl;
			var html = MM.plugins.english.templates.add_video.html;
			MM.panels.show('right', html); 
